...
**Email links:**
- Format: `support@ridewireai.com` or `[Contact Support](mailto:support@ridewireai.com)`
...
2. Emailing support@ridewireai.com
...
**Maintained by:** RideWire AI Team (support@ridewireai.com)
